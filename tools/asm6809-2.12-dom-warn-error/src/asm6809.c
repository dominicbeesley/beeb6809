...
int main(int argc, char **argv) {
	...
	int c;
	while ((c = getopt_long(argc, argv, "BDCSHe:893d:P:o:l:E:s:qvR",
				long_options, NULL)) != -1) {
		switch (c) {
		case 0:
			break;
	...
	asm6809_options.relative_includes = relative_includes;
...
"\n"
"  -R  --relinc    treat include/includebin filenames as being relative to the\n"
"                  current file\n"
...
static void versiontext(void) {
	puts(
"asm6809 " PACKAGE_VERSION "-DB rel, warn, error\n"
