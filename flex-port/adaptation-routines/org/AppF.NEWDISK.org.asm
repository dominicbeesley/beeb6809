...
SMAX51		EQU	30				; SD MAX SIDE 1 SECTORS
	* DOUBLE DENSITY:
...
FORM1		LDA	#SMAXS0				; INITIALIZE SECTOR MAX
		...
		BNE	EXIT				; EXIT IF "NO”
error ;;;; !!!! ;;;; 0152 OF 25 CLR DBSDF CLEAR FLAG
...
SWITCH		LDB	DENSE				; DOUBLE DENSITY DISK?
		...
		STB	DNSITY				; SET FLAG
		LDB	KDMAXS0				; RESET SECTOR COUNTS
		STB	MAXS0
		LDB	#DMAXS1
		STB	MAXS1
		TST	DBSDF				; DOUBLE SIDED?
...
DOTR33		LDA	0,Y+				; COPY NAME TO SIR
		STA	FSB+IRS,X
		LEAX	1,X
error ;;;; !!!! ;;;; 03F5 5A DECB DEC THE COUNT
		BNE	DOTR33
