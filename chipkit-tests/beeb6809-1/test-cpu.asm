...
here2		
		FILL	$FF, $86FF-here2-1
		ORG	$87F0
dumXRESV     FDB  RES_HANDLE  ; $FFF0   ; Hardware vectors, paged in to $FFFx
dumXSWI3V    FDB  SWI3_HANDLE ; $FFF2
dumXSWI2V    FDB  SWI2_HANDLE ; $FFF4
dumXFIRQV    FDB  FIRQ_HANDLE ; $FFF6
dumXIRQV     FDB  IRQ_HANDLE  ; $FFF8
dumXSWIV     FDB  SWI_HANDLE  ; $FFFA
dumXNMIV     FDB  NMI_HANDLE  ; $FFFC
dumXRESETV   FDB  RESET       ; $FFFE

here3		
		FILL	$FF, $F6FF-here3-1
